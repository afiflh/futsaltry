...
<div class="main">
  ...
  <table class="table table-striped">
      ...
      $tanggal = mysqli_real_escape_string($connect, $_POST["tgl"]);
        $a=mysqli_query($connect, "select jadwal.id_jadwal,jadwal.jam,jadwal.jams, harga.harga,harga.id_harga from jadwal,harga WHERE jadwal.id_harga=harga.id_harga order by jadwal.id_jadwal asc");
